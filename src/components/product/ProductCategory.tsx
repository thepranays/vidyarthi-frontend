    ...
    return (
        <div className="h-full">
            ...
            <div className="flex flex-row mt-5 ">
                ...
                }}><div className={`rounded-l-lg flex items-center justify-center  w-24 h-16 ${props.categoryFilterList.has(PRODUCT_TYPE_SELL) ? "dark:bg-indigo-700" : "dark:border dark:border-indigo-900"} dark:hover:bg-indigo-900`}>Buy</div></button>
                ...
                }}><div className={`rounded-r-lg flex items-center justify-center shadow-md w-24 h-16 ${props.categoryFilterList.has(PRODUCT_TYPE_REQUEST) ? "dark:bg-indigo-700" : "dark:border dark:border-indigo-900"} dark:hover:bg-indigo-900`}>Sell</div></button>
            </div>
